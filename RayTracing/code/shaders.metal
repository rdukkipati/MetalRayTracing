                  ...
                  thread ray *ScatteredRay, thread rng *RNG)
{
    *Attenuation         = color3(1.0f, 1.0f, 1.0f);
    ...
    if(CannotRefract ||
       Reflectance(CosTheta, RefractiveRatio) > Random_f32(RNG))
    {
        ...
        thread ray *ScatteredRay, thread rng *RNG)
{
    ...
    switch(Hit->Material.Type)
    {
        case LAMBERTIAN:
        {
            Result = LambertianScatter(Ray, Hit, Attenuation, ScatteredRay,
                                       RNG);
        }
        break;
        ...
        case DIELECTRIC:
        {
            Result = DielectricScatter(Ray, Hit, Attenuation, ScatteredRay,
                                       RNG);
        }
        break;
    }
